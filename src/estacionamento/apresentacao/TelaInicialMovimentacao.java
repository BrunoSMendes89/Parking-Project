...
public class TelaInicialMovimentacao extends JFrame implements ActionListener {
	...
	public TelaInicialMovimentacao() {
		...
		btnEntrar.setIcon(new ImageIcon(TelaInicialMovimentacao.class.getResource("/resources/getin.png")));
		btnEntrar.addActionListener(this);
		btnEntrar.setActionCommand("entrada");
		getContentPane().add(btnEntrar);
		
		btnSair = new JButton("");
		btnSair.setIcon(new ImageIcon(TelaInicialMovimentacao.class.getResource("/resources/getout.png")));
